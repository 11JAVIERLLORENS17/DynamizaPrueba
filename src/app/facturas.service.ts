...
export class FacturasService {
  ...
  editarFactura(factura: Facturas) {
    console.log("ID factura: " + factura.id);
    return this.http.put("http://test-api.jtarrega.es/api/facturas/" + factura.id, factura, httpOptions);
  }
  borrarFactura(id) {

    return this.http.delete("http://test-api.jtarrega.es/api/facturas/" + id);
  }
  introducirFacturas(factura: Facturas): Observable<any> {
    return this.http.post("http://test-api.jtarrega.es/api/facturas", factura, httpOptions);
  }
